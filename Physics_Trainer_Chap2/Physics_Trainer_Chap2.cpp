...
void Excersize_2_6(int solution, int answer)
{
	...
	if (solution == SHOW)
	{
		...
		printf("=================================================================\n");
		// your code here
		printf("관련 공식은 평균속력 입니다. x는 거리, t는 시간일 때 공식은 (xf - xi) / (tf - ti) 입니다.\n");
		printf("먼저 시간의 변화량과 거리의 변화량을 구하세요.\n");
	...
	if (solution == SHOW)
	{
		...
		printf("=================================================================\n");
		// your code here
		printf("관련 공식은 평균속도 입니다. x는 위치, t는 시간일 때 공식은 (xf - xi) / (tf - ti) 입니다.\n");
		printf("먼저 시간의 변화량과 위치의 변화량을 구하세요.\n");
